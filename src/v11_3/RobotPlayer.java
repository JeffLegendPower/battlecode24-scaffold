...
import v11_3.Utils;
import v11_3.robots.Attacker;
import v11_3.robots.Defender;
import v11_3.robots.FlagCarrier;
...
public strictfp class RobotPlayer {
    ...
    private static v11_3.robots.AbstractRobot robot = null;
    ...
    public static void run(RobotController rc) throws GameActionException {
        ...
        for (MapLocation spawn : spawns) {
            ...
            for (MapLocation loc : test) {
                if (v11_3.Utils.indexOf(spawns, loc) == -1)
                    continue spawner;
            }
...
//            }
            ...
            if (!rc.isSpawned() && !isDefender && numVegetables < 5 && false) {
                robot = new v11_3.robots.Vegetable();
                robot.setup(rc);
                isVegetable = true;
