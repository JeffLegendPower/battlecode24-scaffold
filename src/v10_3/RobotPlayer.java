...
public strictfp class RobotPlayer {
    ...
    public static MapInfo[][] lastTurnMap;
    ...
    public static void run(RobotController rc) throws GameActionException {
        ...
        lastTurnMap = new MapInfo[rc.getMapHeight()][rc.getMapWidth()];
        ...
        while (true) {
            try {
                ...
                if (!rc.isSpawned()) {
                    ...
                    MapInfo[] savedMapInfo = new MapInfo[200];
                    int idx = 0;
                    ...
                    if (rc.getRoundNum() < GameConstants.SETUP_ROUNDS - 50) {
                        ...
                        if (!setupAfterSetup && (type == RobotType.Default)) {
...
//                    if (type == RobotType.CornerFinder) System.out.println(rc.getLocation());
                    ...
                    for (MapInfo info : savedMapInfo) {
                        if (info != null) {
                            MapLocation loc = info.getMapLocation();
                            lastTurnMap[loc.y][loc.x] = info;
                        }
                    }
                }
...
//                System.out.println("Exception in v10.3: " + e);
                e.printStackTrace();
            }
        }
    }
