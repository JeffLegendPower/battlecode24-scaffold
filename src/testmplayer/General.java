...
public class General {
    ...
    public static ArrayList<MapLocation> flagHolderVisited = new ArrayList<>();
    ...
    public static int turnsSinceLastMove = 0;
    public static RobotInfo healTarget = null;
    public static Direction lastTryDir = null;
