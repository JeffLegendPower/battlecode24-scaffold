...
public class Pathfinding2 {
    ...
    public Pathfinding2(RobotController rc){
        this.rc = rc;
    }
    ...
    void greedyPath(){
        try {
            ...
            for (Direction dir : directions) {
                ...
                double estimation = getEstimation(newLoc);
    ...
    boolean strictlyCloser(MapLocation newLoc, MapLocation oldLoc, MapLocation target){
        int dOld = target.distanceSquaredTo(oldLoc), dNew = target.distanceSquaredTo(newLoc);
