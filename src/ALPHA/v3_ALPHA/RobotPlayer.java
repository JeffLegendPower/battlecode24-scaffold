...
public strictfp class RobotPlayer {
                ...
                if (!rc.isSpawned()) {
                    ...
                    if (defender) {
                        ...
                        if (enemyRobots.length > 0) {
                            ...
                            // TODO make this work it doesnt work
    ...
    private static List<MapLocation> path = new ArrayList<>();
    ...
    public static void moveTowards(RobotController rc, MapLocation target) throws GameActionException {
        ...
        if (rc.canMove(d)) {
            ...
            for (int i = 0; i < 8; i++) {
                if (rc.canMove(currentDirection) && !path.contains(rc.getLocation().add(currentDirection))) {
